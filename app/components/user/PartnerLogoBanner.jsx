...
// , ...courierPartners
const infinitePartners = [...mockPartners, ...mockPartners];
...
const PartnerLogoBanner = () => {
  return (
    <section className="w-full bg-gray-50 py-12 border-t border-b border-gray-200 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 text-center ">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 flex items-center justify-center gap-3">
      ...
      <div className="relative h-48 sm:h-56 md:h-64 overflow-hidden">
        <div
          className="absolute top-0 left-0 h-full flex flex-nowrap items-center space-x-2"
          style={{
            animation: 'marquee 50s linear infinite',
            width: `${infinitePartners.length * 350}px`,
            minWidth: '200%',
          }}
        >
          {infinitePartners.map((partner, index) => (
            ...
            >
              <div className="relative w-full h-full rounded-lg border border-gray-200 bg-white shadow-sm">
                <Image
