...
import { Edit, Trash2, Eye, Package, ChevronLeft, ChevronRight, ArrowUpRight, RefreshCw } from "lucide-react"
import Image from "next/image";

const CategoriesTable = ({ categories, search, onEdit, onDelete, onToggleStatus }) => {
...
{cat.image_url ? (
  ...
  <Package className="m-auto text-slate-200" size={16} />
                    ...
                    <span className="text-[13px] font-bold text-slate-900 uppercase tracking-tight">{cat.name}</span>
                  </div>
              </td>
              <td className="px-8 py-5">
                  <button 
