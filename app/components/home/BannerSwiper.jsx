...
const BannerSwiper = ({ events }) => {
  ...
  return (
    <section className="lg:col-span-9 rounded-[32px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-white/20 h-[480px] group/container relative bg-slate-950">
            ...
            <SwiperSlide key={event.id}>
              <div className="relative w-full h-full overflow-hidden">
                ...
                <motion.img 
                  ...
                  src={getCleanImageUrl(event.event_image_url) || FALLBACK_BANNER} 
                  alt={event.name} 
