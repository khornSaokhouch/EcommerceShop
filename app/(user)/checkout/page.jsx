...
import { useShippingMethodStore } from "../../stores/useShippingMethod";
import { useUserPaymentMethodStore } from "../../stores/useUserPaymentMethod";
...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      router.push(`/${userId}/checkout/${createdOrder.id}`);
    } catch (error) {
