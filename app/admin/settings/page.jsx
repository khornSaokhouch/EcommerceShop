    ...
    <div className="space-y-10 pb-24 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-slate-400 text-[11px] font-bold uppercase tracking-widest mt-2">Manage hardware registry logic and security nodes</p>
        </div>
        
        <button
          onClick={handleSave}
          disabled={isProcessing}
          className="group relative px-10 py-4 bg-slate-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] overflow-hidden transition-all active:scale-[0.98] shadow-xl"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-white rounded-[32px] p-6 border border-slate-100 shadow-sm">
             <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] mb-6 px-2">Configuration Nodes</h3>
          ...
          <div className="bg-slate-900 rounded-[32px] p-8 text-white relative overflow-hidden shadow-2xl">
             ...
             <p className="text-[9px] font-black text-blue-400 uppercase tracking-widest mb-1">System Load</p>
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="bg-white rounded-[32px] p-8 sm:p-10 border border-slate-100 shadow-sm">
            ...
            <div className="space-y-8">
               ...
               <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Registry Objective</label>
                  <textarea 
                    rows="3"
          ...
          <div className="bg-white rounded-[32px] p-8 sm:p-10 border border-slate-100 shadow-sm">
            ...
            <div className="space-y-8">
               <div className="space-y-2">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">Master Security Key</label>
                  <div className="relative">
                    <input 
                        type={showKey ? "text" : "password"}
                        className="w-full bg-slate-50 border-none rounded-2xl py-4 pl-12 pr-12 text-sm font-bold text-slate-800 focus:bg-white focus:ring-4 focus:ring-blue-500/5 transition-all outline-none"
